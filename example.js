...
.then(_ => driver.wait(until.elementLocated(xpath('//*[@id="State_Code"]'), 100000)))
        .then(_ => driver.wait(until.elementLocated(xpath('//*[@id="District_CodeDDL"]/option[@value="525"]'), 5000)))
        	.then(
        		_ => driver.quit(), 
